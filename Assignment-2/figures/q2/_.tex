...
\begin{tikzpicture}
    ...
    \draw[->, line width=1.5pt] (-0.1,0) -- (-0.1,-1) node[midway,left] {$\vec{F}$};

    % Frictional force
    \draw[->, line width=1.5pt] (0,-1.5) -- (1,-1.5) node[midway,below] {$f_f$};

    % Chassis force
    \draw[->, line width=1.5pt] (0,-1.5) -- (-1.5,-1.5) node[midway,below] {$T_f$};
