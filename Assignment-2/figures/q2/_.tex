...
\begin{tikzpicture}
    ...
    % Normal force
    \draw[->, line width=1.5pt] (0,-1.5) -- (0,-0.5) node[midway,right] {$\vec{\mathbf{N_f}}$};
    ...
    \draw[->, line width=1.5pt, black!50] (-0.6,0) arc[start angle=180, end angle=20, radius=0.5];
    \node [right, black!50] at (0.35,0.4) {$\vec{\mathbf{M_F}}$};

    % Moment due to the frictional force
    \draw[->, line width=1.5pt, black!50] (0,-1.5) arc[start angle=270, end angle=200, radius=0.5];
...
\begin{tikzpicture}
    ...
    % Normal force
    \draw[->, line width=1.5pt] (0,-1) -- (0,-0.3) node[midway,right] {$\vec{\mathbf{N_b}}$};
...
\begin{tikzpicture}
    ...
    \begin{scope}
        ...
        % Applied force on the pedal
        \draw[->, line width=1.5pt] (-0.09,0) -- (-0.09,-1) node[midway,left] {$\vec{\mathbf{F}}$};
        ...
        \node [right] at (0.5,0.1) {$\vec{\mathbf{M}}$};
    \end{scope}
