...
\begin{tikzpicture}
    ...
    % Forces
    \draw[->, line width=1.5pt] (1,-1) -- ++(0,-1.5) node[right] {\(\frac{7}{2}F\)};
...
\begin{tikzpicture}
    ...
    % Forces
    \draw[->, line width=1.5pt] (0.8,-0.8) -- ++(0.5,-1) node[pos=0.9, above, yshift=3] {\(F_{e}\)};
    \fill[black] (0.8,-0.8) circle (0.05);
